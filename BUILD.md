...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/nextcloud:29.0-bookworm 29.0/debian/nextcloud/default/
docker build --no-cache --pull --tag nicoherbigde/nextcloud-database:29.0-bookworm 29.0/debian/nextcloud-database/default
```
...
docker push nicoherbigde/nicoherbigde/nextcloud:29.0-bookworm
docker push nicoherbigde/nicoherbigde/nextcloud-database:29.0-bookworm
```
