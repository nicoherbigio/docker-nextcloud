...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/nextcloud:33.0-trixie 33.0/debian/nextcloud/default/
docker build --no-cache --pull --tag nicoherbigde/nextcloud-database:33.0-noble 33.0/ubuntu/nextcloud-database/default
```
...
docker push nicoherbigde/nicoherbigde/nextcloud:33.0-trixie
docker push nicoherbigde/nicoherbigde/nextcloud-database:33.0-noble
```
