...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/nextcloud:32.0-trixie 32.0/debian/nextcloud/default/
docker build --no-cache --pull --tag nicoherbigde/nextcloud-database:32.0-bookworm 32.0/debian/nextcloud-database/default
```
...
docker push nicoherbigde/nicoherbigde/nextcloud:32.0-trixie
docker push nicoherbigde/nicoherbigde/nextcloud-database:32.0-bookworm
```
